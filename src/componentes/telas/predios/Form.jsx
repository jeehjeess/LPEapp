...
function Form() {
    ...
    return (
        <Dialogo id="modalEdicao" titulo="Prédios" >
            ...
            <CampoEntrada id="txtNome" label="Nome" tipo="text" name="nome" value={objeto.nome}
                onchange={handleChange} requerido={true} readonly={false} tamanho={40}
                msgvalido=" Campo nome OK" msginvalido="Campo nome é obrigatório" />
            ...
            <CampoEntrada id="txtSigla" label="Sigla" tipo="text" name="sigla" value={objeto.sigla}
                onchange={handleChange} requerido={true} readonly={false} tamanho={40}
                msgvalido=" Campo sigla OK" msginvalido="Campo sigla é obrigatório" />
